...
public class SfListViewTestViewModel
{
    ...
    // Constructor
    #region SfListViewTestViewModel
    /// <summary>
    /// SfListViewTestViewModel
    /// </summary>
    public SfListViewTestViewModel()
    {
        ...
        bookInfo.Add(new BookInfo() { BookName = "Machine Learning Using C# 2", BookDescription = "You will learn several different approaches to applying machine learning." });
    }
    #endregion
}